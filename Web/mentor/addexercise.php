...
if(isset($_GET['exercisedata']) && isset($_GET['subdata']) && isset($_GET['chdata']))
{
	$v_id = mysqli_real_escape_string($con,$_GET['exercisedata']);
	$v_id = base64_decode($v_id);
	$subject_id = mysqli_real_escape_string($con,$_GET['subdata']);
	$subject_id = base64_decode($subject_id);
    $ch_id = mysqli_real_escape_string($con,$_GET['chdata']);
	$ch_id = base64_decode($ch_id);    
...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">Manage Exercise</a></li>
                                    <li><a href="#tab-2">Add Exercise</a></li>
                                ...
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/manageexercise.php');
                                            ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                            <form onsubmit="return addexe(this);" id="myform6" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                              <label for="header">Excercise Title:<sup style="color:red;">*</sup></label>
                                              <input type="text" class="form-control" name="title" id="title" aria-describedby="helpId" placeholder="Excercise Title" required />
                                            </div>
                                            
                                            <div class="form-group">
                                              <label for="header">Excercise Desc:<sup style="color:red;">*</sup></label>
                                              <input type="text" class="form-control" name="descr" id="descr" aria-describedby="helpId" placeholder="Excercise Description" required />
                                            </div>
                                            
                                            <label for="">Excercise PDF:<sup style="color:red;">*</sup></label>        
                                              
                                            		<input type="file" style="height:45px; border:none;" name="pdffile" id="pdffile" required>
    ...
    ******************************************-->   
    ...
    <script src="ajax/addexercise.js"></script>
    <script src="ajax/removeexe.js"></script>
    <script src="ajax/fetchex.js"></script>
    <script src="ajax/updateex.js"></script>
