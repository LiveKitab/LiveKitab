                ...
                <div class="ps-tabs">
                    <div class="ps-tab active" id="sign-in">
                        <div class="ps-form__content">
                            <center><h5>Log In Your Account</h5>
                            
                            <img src="../img/card/1.png" alt="Avatar" class="avatar"></center>
                            
                            <div class="row">
                            <div class="col-md-6 form-group submtit">
                                <button type="submit" class="ps-btn ps-btn--fullwidth" name="login" id="login">Login</button>
                            </div>
                            
                            <div class="col-md-6 form-group submtit">
                                <button type="submit" class="ps-btn ps-btn--fullwidth" name="account" id="account">Switch Account </button>
                            </div>
                            </div>
                            
                            <center><p><a href="#"  ><u>Remove Password ?</u></a></p></center>
                            
                            <div class="row">
                            <div class="col-md-6 form-group submtit" >
                            <p align="left" style="padding-top: 35px;"><a href="#" ><u>< Back to Home</u></p>
                            </div>
                            </div>
