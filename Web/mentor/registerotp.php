...
<main id="homepage-photo">
    <div class="ps-my-account">
        ...
        <div class="container">
            <form id="reg_otp_form" method="POST" class="ps-form--account ps-tab-root">
                <ul class="ps-tab-list">
                    <li class="active"><a>OTP</a></li>
                </ul>
                <div class="ps-tabs">
                    <div class="ps-tab active" id="register">
                        <div class="ps-form__content">
                            ...
                            <div class="form-group form-forgot">
                                <input type="password" class="form-control" name="reg_otp" id="reg_otp"
                                        aria-describedby="helpId" placeholder="Enter OTP" required /> <a
                                        style="color:black;">
                                        <span></span>
                                        <span toggle="#password-field"
                                            class="fa fa-fw fa-eye field-icon toggle-password"></span></a>
                            </div>
                            <small id="helpId" class="form-text" style="color:red; font-size:10pt;margin-top:-3%;">Note&nbsp;:&nbsp;Otp Comes In Your Mail Address.!</small><br>
                            <div class="form-group submtit">
                                    <button type="submit" name="reg_ver" id="reg_ver" class="ps-btn ps-btn--fullwidth">Submit</button>
