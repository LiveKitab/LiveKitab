...
<main id="homepage-photo">
    <div class="ps-my-account">
        ...
        <div class="container">
            <form id="reg_email_form" method="POST" class="ps-form--account ps-tab-root">
                        ...
                        <div class="ps-form__content">
                            ...
                            <div class="form-group form-forgot">
                                <input type="email" class="form-control" name="reg_email" id="reg_email"
                                        aria-describedby="helpId" placeholder="Enter Your Registered Email" required />
                            </div>
                            
                            <div class="form-group submtit">
                                    <button type="submit" name="e_submit" id="e_submit" class="ps-btn ps-btn--fullwidth">Submit</button>
