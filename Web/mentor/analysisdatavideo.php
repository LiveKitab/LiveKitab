...
include_once("back/function/session.php");
	if(isset($_POST['go']))
	{
	    ...
	    $cmd="select * from creator_video where v_id='$v_id' ORDER BY id ASC";
                            ...
                            <td>
                                <div>
                                    ...
                                    <?php
                                        ...
                                        {
                                            ?>
                                                <button type="button" class="ps-btn reply" style="background-color:#dc3545;color:white;">Reply</button>
                                            <?php
                                        }
