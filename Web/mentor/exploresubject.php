...
<body>
                                        ...
                                        <div class="ps-document">
                                            ...
                                            <table id="load" class="table table-hover table-bordered zero-configuration">
                                              ...
                                              <tbody align="center">
                                                <?php
                                            $count = 0; 
                                              $cmd="select * from term_data ORDER BY id ASC";
                                              ...
                                              ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                       <a role="button" class="ps-btn" href="applysub?unidata=<?=base64_encode($university_id);?>&stramdata=<?=base64_encode($stream_id);?>&programdata=<?=base64_encode($pr_id);?>&branchdata=<?=base64_encode($b_id);?>&termdata=<?=base64_encode($term_id);?>&subdata=<?=base64_encode($sub_id);?>"><i class="fa fa-plus"></i></a>             
                                                    </td>
                                                </tr>
                                                <?php
                                                }
   ...
   <script>
    ...
    var table = $('#load').DataTable( {
        aLengthMenu: [[10, 50, 75, 100], [10, 50, 75, "All"]],
        iDisplayLength: 10
    } );
