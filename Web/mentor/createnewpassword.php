...
$email = base64_decode($_SESSION['c_email']);
?>
<!DOCTYPE html>
<html lang="en">
...
<main id="homepage-photo">
    <div class="ps-my-account">
        ...
        <div class="container">
            <form id="ResetPwdForm" method="POST" class="ps-form--account ps-tab-root">
                <ul class="ps-tab-list">
                    <li class="active"><a>Create New Password</a></li>
                </ul>
                <div class="ps-tabs">
                        ...
                        <div class="ps-form__content">
                            ...
                            <div class="form-group form-forgot">
                                <input type="password" class="form-control" name="newpwd" id="newpwd"
                                        aria-describedby="helpId" placeholder="Enter New Password" required /> <a
                                        style="color:black;">
                                        <span></span>
                                        <span toggle="#password-field"
                                            class="fa fa-fw fa-eye field-icon resetpwd"></span></a>
                            </div>
                            
                            <div class="form-group form-forgot">
                                <input type="password" class="form-control" name="confirmpwd" id="confirmpwd"
                                        aria-describedby="helpId" placeholder="Confirm Password" required />
                            </div>
                            
                            <div class="form-group submtit">
                                    <button type="submit" name="create" id="create" class="ps-btn ps-btn--fullwidth">Submit</button>
