          ...
          <div class="table-responsive">
            <table id="load" class="table table-hover table-bordered zero-configuration">
              ...
              <tbody align="center">
                <?php
              $count = 0; 
              $cmd="select * from video_test_data where v_id='$v_id'";
              ...
              ?>
                <tr id="delete<?php echo $row['id'] ?>" class="showmodal">
                    ...
                    <td>
                        ...
                        <td>
                            <a class="ps-btn" target="_blank" href="addquestion?questringdata=<?=$test_id;?>" style="background-color:#ffc107;">Manage</a>
                        </td>
