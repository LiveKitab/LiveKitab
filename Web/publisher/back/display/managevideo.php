        <div class="table-responsive">
            <table id="load" class="table table-hover table-bordered zero-configuration">
              ...
              <tbody align="center">
                <?php
            $count = 0; 
              $cmd="select * from creator_video where subject_id='$course_id' and v_status='0' ORDER BY sequence ASC";
              ...
              ?>
                <tr id="delete<?php echo $row['id'] ?>">
                    ...
                    <td>
                <button onclick="approvevideo(<?php echo $row['id'];  ?>)" title="Approve" class="ps-btn" style="background-color:#28a745;"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></button>             

                    
                    
                    <button onclick="rejectvideo(<?php echo $row['id'];  ?>)" title="Reject" class="ps-btn" style="background-color:#dc3545;"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></button></td>              
