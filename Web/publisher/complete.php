        ...
        <div class="ps-document">
            ...
            <table id="load1" class="table table-hover table-bordered zero-configuration" width="100%">
              ...
              <tbody align="center">
                <?php
             $count = 0;     
             $cmd3="select * from course_data where e_id='$e_id'";
             ...
             while($row=mysqli_fetch_array($result3))
             {
              ...
              $cmd="select * from term_data where term_id='$term_id'";
              ...
              ?>
                <tr>
                    ...
                    <td>
                      <a type="button" href="completevideo?qstringdata=<?php echo $course_id; ?>" class="ps-btn"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
              <?php
            }
