...
<body>
        ...
        <div class="container">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li>Subject Name:<a href="assign"><?php echo $course_name; ?></a>&nbsp;&nbsp;Subject Code:<a href="assign"><?php echo $subcode; ?></a></li>
                    <li>Assigned Video</li>
                </ul>
            </div>
        </div>
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    ...
                                    <li><a href="#tab-2">All Video </a></li>
                                    <li><a href="#tab-3">Approve Video </a></li>
                                    <li><a href="#tab-4">Reject Video </a></li>
                                    <li><a href="#tab-5">Subject Video</a></li>
                                </ul>
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/managevideo.php');
                                            ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-3">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/approvevideo.php');
                                            ?>  
                                    ...
                                    <div class="ps-tab" id="tab-4">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/rejectvideo.php');
                                            ?>  
                                    ...
                                    <div class="ps-tab" id="tab-5">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/coursesvideo.php');
                                            ?>  
    ...
    ******************************************-->   
    ...
    <script src="ajax/appr&rejvideo.js"></script>
    <script src="ajax/fetchcompletevideo.js"></script>
    <script src="ajax/addfinalvideo.js"></script>
