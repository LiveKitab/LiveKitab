...
if(isset($_GET['stringdata']) && isset($_GET['stringdata1']) && isset($_GET['stringdata2']) && isset($_GET['stringdata3']) && isset($_GET['stringdata4'])&& isset($_GET['stringdata5']))
	{
	    ...
	    $sub_id = mysqli_real_escape_string($con,$_GET['stringdata5']);
	    $sub_id = base64_decode($sub_id);
	    
	    $ch = "select sub_name from subject_data where sub_id='$sub_id'";
    	$runtermn=mysqli_query($con,$ch) or die(mysqli_error($con));
        while($rowtmn=mysqli_fetch_array($runtermn))
        {
            $sub_name=$rowtmn['sub_name'];
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a href="Add_University"><b><?=$sub_name;?></b></a></li>
                    <li>Add Chapters</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View Chapter</a></li>
                                    <li><a href="#tab-2">Add chapter</a></li>
                                </ul>
                                ...
                                <div class="ps-tabs">
                                    ...
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/displaychapter.php');
                                            ?>
                                            <div id="return"></div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                              <form onsubmit="return chapter(this);" id="myform7" method="post" enctype="multipart/form-data">
                                              ...
                                              <input type="text" class="form-control" name="ch_no" id="ch_no" aria-describedby="helpId" placeholder="Chapter Number" required />
                                            </div>
                                                
                                            <div class="form-group">
                                              <label for="header">Chapter Name:<sup style="color:red;">*</sup></label>
                                            ...
                                            <button type="submit" name="c_submit" id="c_submit" class="ps-btn" style="background-color:#28a745;">Add</button>
    ...
    ******************************************-->   
    ...
    <script src="ajax/removechapter.js"></script>
    <script src="ajax/fetchchapter.js"></script>
    <script src="ajax/updatechapter.js"></script>
