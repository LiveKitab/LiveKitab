...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View University </a></li>
                                    <li><a href="#tab-2"> Add University </a></li>
                                </ul>
                                <div class="ps-tabs">
                                     ...
                                     <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/displayuni.php');
                                            ?>
                                            </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                              <form onsubmit="return uni(this);" id="myform4" method="post" enctype="multipart/form-data">

                                            <div class="form-group">
                                              <label for="header">University Name:<sup style="color:red;">*</sup></label>
                                              <input type="text" class="form-control" name="uname" id="uname" aria-describedby="helpId" placeholder="University Name" required />
                                            </div>
    ...
    ******************************************-->   
    ...
    <script src="ajax/removeuni.js"></script>
    <script src="ajax/fetchuni.js"></script>
    <script src="ajax/updateuniver.js"></script>
