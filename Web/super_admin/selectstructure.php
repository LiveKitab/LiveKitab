                        ...
                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">Select Structure</a></li>
                                </ul>
                                <div class="ps-tabs">
            ...
            $count = 0; 
              ...
              ?>
                <tr>
                    ...
                    <td>
                    <a role="button" class="ps-btn" href="addcourse?ststringdata=<?php echo $stream_id1; ?>&prstringdata=<?php echo $pr_id1; ?>&bstringdata=<?php echo $b_id1; ?>&tstringdata=<?php echo $t_id; ?>"><i class="fa fa-plus"></i></a>             
                    </td>
                  </tr>
              <?php
