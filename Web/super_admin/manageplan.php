...
<body>
                                ...
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/manageplan.php');
                                        ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
    ...
    ******************************************-->   
    ...
    <script src="ajax/manageplan.js"></script>
    <script src="ajax/removeplan.js"></script>
    <script src="ajax/fetchplan.js"></script>
    <script src="ajax/updateplan.js"></script>
