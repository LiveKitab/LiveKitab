            ...
            <table id="load3" class="table table-hover table-bordered zero-configuration">
              ...
              ?>
                <tr id="delete<?php echo $row['id'] ?>">
                    ...
                    <td>
                        <a href="addsubject?stringdata=<?=$university_id;?>&stringdata1=<?=$stream_id;?>&stringdata2=<?=$pr_id;?>&stringdata3=<?=$b_id;?>&stringdata4=<?=$term_id;?>" style="background-color:#20c997;" class="ps-btn"><i class="fa fa-plus"></i> Add Subject</a>
                    </td>
                    <td>
