          ...
          <div class="table-responsive">
            <table id="load" class="table table-hover table-bordered zero-configuration">
              ...
              ?>
                <tr id="delete<?php echo $row['id'] ?>">
                    ...
                    <td>
                        <a href="add_year_medium?stringdata=<?php echo $u_id; ?>" style="background-color:#20c997;" class="ps-btn"><i class="fa fa-plus"></i> Add Medium</a>
                    </td>
                    <td>
            ...
            include("back/modal/update_year_uni.php");
            ?>
              </tbody>
