<?php
  include("../../../db/connect.php");
      ...
      if(isset($_POST['id']) && isset($_POST['m_name']) && isset($_POST['m_fname']) && isset($_POST['m_lname'])
       && isset($_POST['m_cont']) && isset($_POST['m_email']) && isset($_POST['m_addr']) && isset($_POST['discount']))
      {
            ...
            $sel = "update creator_data set c_name='$m_name',c_fname='$m_fname',c_lname='$m_lname',c_cno='$m_cont',c_email='$m_email',c_addr='$m_addr',discount='$discount' where id='$id'";
