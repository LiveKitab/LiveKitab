...
<body>
                                            ...
                                            <div class="table-responsive">
                                                <table id="load1" class="table table-hover table-bordered zero-configuration" width="100%">
                                                  <thead class="thead-dark" align="center">
                                                    ...
                                                    <?php
                                                      $count = 0; 
                                                      $cmd="select * from mentor_transaction";
                                                    ...
                                                    <td>
                                                       <a role="button" class="ps-btn editpayment" style="background-color:#007bff;">Pay</a>             
                                                    </td>
                                                    </tr>
                                                    <?php
                                                    include("back/modal/paymodal.php");
                                                }
                                                ?>
                                                </tbody>
    ...
    ******************************************-->   
    ...
    <script src="ajax/fetchpayment.js"></script>
    <script src="ajax/updatepayment.js"></script>
    <script>
