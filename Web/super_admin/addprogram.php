...
if(isset($_GET['stringdata']))
	{
	    $s_id = mysqli_real_escape_string($con,$_GET['stringdata']);
	    $s_id = base64_decode($s_id);
	    
	    $uni_id = mysqli_real_escape_string($con,$_GET['stringdata1']);
	    $uni_id = base64_decode($uni_id);
	    
	    $strm = "select stream_name from stream_data where stream_id='$s_id'";
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View Program</a></li>
                                    <li><a href="#tab-2">Add Program</a></li>
                                </ul>
                                <div class="ps-tabs">
                                    ...
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/displayprogram.php');
                                            ?>
                                            <div id="return"></div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                              <form onsubmit="return program(this);" id="myform1" method="post" enctype="multipart/form-data">

                                        <input type="hidden" name="s_id" id="s_id" value="<?php echo $s_id; ?>">
                                        <input type="hidden" name="uni_id" id="uni_id" value="<?php echo $uni_id; ?>">
<div class="form-group">
  <label for="header">Program Name:<sup style="color:red;">*</sup></label>
  <input type="text" class="form-control" name="pname" id="pname" aria-describedby="helpId" placeholder="Program Name" required />
</div>



<small id="helpId" class="form-text" style="color:red; font-size:10pt;">- EX.Program Name&nbsp;:&nbsp;BE,ME,MBA,etc<br/>* Fields are
                        Mandatory</small><br>

<button type="submit" name="p_submit" id="p_submit" class="ps-btn" style="background-color:#28a745;">Add</button>
...
<div class="loader" id="loader">
    ...
    ******************************************-->   
    ...
    <script src="ajax/removeprogram.js"></script>
    <script src="ajax/fetchprogram.js"></script>
    <script src="ajax/updateprogram.js"></script>
