  ...
  <div class="row">  
    <?php
      ...
      <div class="card bg-white col-md-2" style="background-image: url('../img/card/<?php echo $name; ?>.png'); margin: 0% 1% 1% 1%;">
          <div class="card-header text-white" style="font-size:15pt;"><?php echo $stream_name; ?></div>
          
          <div class="card-footer">
        <a type="button" href="program_of_course?ststringdata=<?php echo $stream_id; ?>" class="ps-btn">Go</a>
          </div>
        </div>
