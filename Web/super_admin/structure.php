...
if(isset($_GET['stringdata']))
	{
	    $u_id = mysqli_real_escape_string($con,$_GET['stringdata']);
	    $u_id = base64_decode($u_id);
	    
	    $strm = "select uni_name from university_data where university_id='$u_id'";
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View Stream</a></li>
                                    <li><a href="#tab-2"> Add Stream</a></li>
                                </ul>
                                <div class="ps-tabs">
                                     ...
                                     <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/displaystream.php');
                                            ?>
                                            </div>
                                    </div>
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                              <form onsubmit="return stream(this);" id="myform" method="post" enctype="multipart/form-data">
                                               <input type="hidden" name="u_id" id="u_id" value="<?php echo $u_id; ?>">


<div class="form-group">
  <label for="header">Stream Name:<sup style="color:red;">*</sup></label>
  <input type="text" class="form-control" name="sname" id="sname" aria-describedby="helpId" placeholder="Stream Name" required />
</div>



<small id="helpId" class="form-text" style="color:red; font-size:10pt;">-EX&nbsp;:&nbsp;Stream Name&nbsp;:&nbsp;Engeeniring,BSC,etc<br/>* Fields are
                        Mandatory</small><br>
...
<div class="loader" id="loader">
    ...
    ******************************************-->   
    ...
    <script src="ajax/removestructure.js"></script>
    <script src="ajax/fetchstructure.js"></script>
    <script src="ajax/updatestructure.js"></script>
