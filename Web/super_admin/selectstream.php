        ...
        <div class="container">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li>Select University-Stream</li>
                </ul>
            </div>
        </div>
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">Select Stream</a></li>
                                </ul>
                                <div class="ps-tabs">
  ...
  <div class="row">  
    <?php
      ...
      <div class="card bg-white col-md-2" style="background-image: url('../img/card/<?php echo $name; ?>.png'); margin: 0% 1% 1% 1%;">
          <div class="card-header text-white" style="font-size:15pt;">University: <?php echo $uni_name; ?></div>
          <div class="card-body">
            <h5 class="card-title text-white" style="font-size:13pt;">Stream: <?php echo $stream_name; ?></h5>
          </div>
          <div class="card-footer">
        <a type="button" href="selectprogram?ststringdata=<?php echo $stream_id; ?>" class="ps-btn">Go</a>
          </div>
        </div>
