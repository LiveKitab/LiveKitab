                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View Banner</a></li>
                                    <li><a href="#tab-2">Add Banner</a></li>
                                </ul>
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/displaybanner.php');
                                            ?>  
                                    ...
                                    <div class="ps-tab" id="tab-2">
                                        <div class="ps-document">
                                              <form onsubmit="return banner(this);" id="myform4" method="post" enctype="multipart/form-data">

<div class="form-group">
  <label for="header">Client Name:<sup style="color:red;">*</sup></label>
  <input type="text" class="form-control" name="bname" id="bname" aria-describedby="helpId" placeholder="Client Name" required />
</div>
  ...
  <label for="header">Client Contact:<sup style="color:red;">*</sup></label>
  <input type="number" class="form-control" name="cont" id="cont" aria-describedby="helpId" placeholder="Client Contact" required />
</div>

<div class="col-md-6 form-group">
  <label for="header">Client Email:<sup style="color:red;">*</sup></label>
  <input type="email" class="form-control" name="email" id="email" aria-describedby="helpId" placeholder="Client Email" required />
</div>
</div>
...
<div class="col-md-6 form-group">
  <label for="header">Discount:<sup style="color:red;">*</sup></label>
...
<div class="row">
  <div class="col-md-6 form-group">
  <label for="header">Start Date:<sup style="color:red;">*</sup></label>
  <input type="date" class="form-control" name="sdate" id="sdate" aria-describedby="helpId" placeholder="Start Date" required />
</div>

<div class="col-md-6 form-group">
  <label for="header">End Date:<sup style="color:red;">*</sup></label>
  <input type="date" class="form-control" name="edate" id="edate" aria-describedby="helpId" placeholder="End Date" required />
</div>
</div>

<label for="">Banner Image:<sup style="color:red;">*</sup></label>        
  <div class="col-sm-2 imgUp">
    <div class="imagePreview"></div>

				<input type="file" class="uploadFile img" style="height:45px; border:none;" name="b_img" id="b_img">
...
<div class="loader" id="loader">
    ...
    ******************************************-->   
    ...
    <script src="ajax/addbanner.js"></script>
