...
if(isset($_GET['packagestringdata']))
	{
	    $pkg_id = mysqli_real_escape_string($con,$_GET['packagestringdata']);
	    $pkg_id = base64_decode($pkg_id);
	    
	    $sel="select * from package where pkg_id='$pkg_id'";
	    $run=mysqli_query($con,$sel);
	    while($col=mysqli_fetch_array($run))
	    {
	        $term_id=$col['term_id'];
	        $stream_id=$col['stream_id'];
	        $b_id=$col['b_id'];
	        $pr_id=$col['pr_id'];
	        $pkg_title=$col['pkg_title'];
	    }
        ...
        <div class="container">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li>Package Title : <?php echo $pkg_title; ?></li>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">View Video</a></li>
                                    <li><a href="#tab-2">Add Video</a></li>
                                </ul>
                                <div class="ps-tabs">
                                    ...
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/managepkg.php');
                                        ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
                ...
                <div class="form-group">
                  <label for="">Select Subject :<sup style="color:red;">*</sup></label>
                  <select class="form-control browser-default custom-select" name="subject" id="subject" required>
...
<button type="submit" name="psubmit" id="psubmit" class="ps-btn" style="background-color:#28a745;">Add</button>
...
<div id="pkg"></div>
    ...
    ******************************************-->   
    ...
    <script src="../js/main.js"></script>
     <script src="ajax/managepkg.js"></script>
     <script src="ajax/fetchmanagepkg.js"></script>
     <script src="ajax/removemanagepkg.js"></script>
     <script src="ajax/updatemanagepkg.js"></script>
