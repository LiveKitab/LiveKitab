...
<body>
  ...
  <div class="row">  
    <?php
         $cmd="select * from program_data where stream_id='$stream_id'";
      ...
      <div class="card bg-white col-md-2" style="background-image: url('../img/card/<?php echo $name; ?>.png'); margin: 0% 1% 1% 1%;">
          <div class="card-header text-white" style="font-size:15pt;"><?php echo $program_name; ?></div>
          
          <div class="card-footer">
        <a type="button" href="branch_of_course?ststringdata=<?php echo $ps_id; ?>&prstringdata=<?php echo $pr_id; ?>" class="ps-btn">Go</a>
          </div>
        </div>
