...
<body>
                ...
                <ul class="breadcrumb">
                    ...
                    <aside class="widget widget_shop ps-product__box">
                        ...
                        <div id="scrollbar" class="statelist" style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                            ...
                            <?php
                                $q = "select distinct e_state from editor_data order by e_state asc";
                                ...
                                <div class="ps-checkbox">
                                    <input class="form-control filter-checkbox-e_state" type="checkbox" id="<?php echo $rows['e_state']; ?>" name="<?php echo $rows['e_state']; ?>" value="<?php echo $rows['e_state']; ?>">
                                    <label for="<?php echo $rows['e_state']; ?>"><?php echo $rows['e_state']; ?></label>
                                </div>
                            <?php
                            }               
                            ?>
                        ...
                        <div id="scrollbar" class="citylist" style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                            <?php
                                $q1 = "select distinct e_city from editor_data order by e_city asc";
                                ...
                                ?>
                                <div class="ps-checkbox">
                                    <input class="form-control filter-checkbox-e_city" type="checkbox" id="<?php echo $row1['e_city']; ?>" name="<?php echo $row1['e_city']; ?>" value="<?php echo $row1['e_city']; ?>">
                                    <label for="<?php echo $row1['e_city']; ?>"><?php echo $row1['e_city']; ?></label>
                                </div>
                            <?php
                            }               
                            ?>
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 " style="margin-bottom:30px;">
                            <div class="ps-product__box">
                                <ul class="ps-tab-list">
                                    <li class="active"><a href="#tab-1">Manage Publisher</a></li>
                                ...
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/managepublisher.php');
                                        ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
    ...
    ******************************************-->   
    ...
    <script src="ajax/removepublisher.js"></script>
    <script src="ajax/managepublisher.js"></script>
    <script src="ajax/fetchpublisher.js"></script>
    <script src="ajax/updatepublisher.js"></script>
    ...
    $('.filter-checkbox-e_state').on('change', function(e){
      var searchTerms = []
      $.each($('.filter-checkbox-e_state'), function(i,elem){
    ...
    $('.filter-checkbox-e_city').on('change', function(e){
      var searchTerms = []
      $.each($('.filter-checkbox-e_city'), function(i,elem){
        if($(elem).prop('checked')){
          searchTerms.push("^" + $(this).val() + "$")
        }
      })
