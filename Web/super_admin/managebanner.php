...
<body>
                                ...
                                <div class="ps-tabs">
                                    <div class="ps-tab active" id="tab-1">
                                        <div class="ps-document">
                                            <?php 
                                            include_once('back/display/managebanner.php');
                                        ?>  
                                            <div id="return"></div>     
                                        </div>
                                    </div>
    ...
    ******************************************-->   
    ...
    <script src="ajax/managebanner.js"></script>
    <script src="ajax/removebanner.js"></script>
    <script src="ajax/fetchbanner.js"></script>
    <script src="ajax/updatebanner.js"></script>
