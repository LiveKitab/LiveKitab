...
<main id="homepage-photo">
                    ...
                    <div class="ps-tab active" id="sign-in">
                        <div class="ps-form__content">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="sa_email" id="sa_email"
                                    placeholder="Email Address">
                            </div>
                            <div class="form-group form-forgot">
                                <input class="form-control" type="password" name="sa_pwd" id="sa_pwd"
 ...
 var x = document.getElementById("sa_pwd");
            if (x.type === "password") {
                x.type = "text";
            } else {
                x.type = "password";
