...
<head>
    ...
    <link rel ="icon" href="img/icons/favicon.png" type = "image/x-icon">    <link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,500,600,700&amp;amp;subset=latin-ext" rel="stylesheet">
...
<body>
        ...
        <div class="header__top">
            <div class="container">
                <div class="header__left">
                    <a class="ps-logo" href="index.html"><img src="img/logo-photo.png" alt=""></a>
    ...
    <header class="header header--mobile furniture" data-sticky="true">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left">
                <a class="ps-logo" href="index.html"><img src="img/logo-furniture.png" alt=""></a>
            </div>
            <div class="navigation__right">
    ...
    <div class="navigation--list">
        <div class="navigation__content"><a class="navigation__item ps-toggle--sidebar" href="#menu-mobile"><i class="icon-menu"></i><span> Menu</span></a><a class="navigation__item ps-toggle--sidebar" href="#navigation-mobile"><i class="icon-list4"></i><span> Categories</span></a>
            <a
                class="navigation__item ps-toggle--sidebar" href="#search-sidebar"><i class="icon-magnifier"></i><span> Search</span></a><a class="navigation__item ps-toggle--sidebar" href="#cart-mobile"><i class="icon-bag2"></i><span> Cart</span></a></div>
    </div>
    ...
    <div id="homepage-8">
        <div class="ps-home-banner">
            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1"
                ...
                <div class="ps-banner--furniture" data-background="img/slider/home-8/1.jpg"><img src="img/slider/home-8/1.jpg" alt="">
                    <div class="ps-banner__content">
                        <h4>Limit Edition</h4>
                        <h3>TOP <br/> RATED <br/> COURSE 1 <strong> 40%</strong></h3><a class="ps-btn" href="#">Buy Now</a>
                    </div>
                </div>
                <div class="ps-banner--furniture" data-background="img/slider/home-8/2.jpg"><img src="img/slider/home-8/2.jpg" alt="">
                    <div class="ps-banner__content">
                        <h4>Version 2018</h4>
                        <h3>TOP <br/> RATED <br/> COURSE 2 <strong> $599</strong></h3><a class="ps-btn" href="#">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="ps-section__content">
                    <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="4"
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/11.jpg" alt=""></a>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/1.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/2.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/3.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/4.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/5.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/6.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/7.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
        ...
        <div class="ps-home-categories ps-section--furniture">
            <div class="container">
                <div class="ps-section__header">
                    <h3>Course By Branch</h3>
                </div>
                <div class="ps-section__content">
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/1.png" alt="">
                                <p>Sofas</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/2.png" alt="">
                                <p>Chairs</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/3.png" alt="">
                                <p>Tables</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/4.png" alt="">
                                <p>TV Boards</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/5.png" alt="">
                                <p>Storages</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/6.png" alt="">
                                <p>Rugs</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/7.png" alt="">
                                <p>Lamp &amp; Lighting</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/8.png" alt="">
                                <p>Furnishings</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/9.png" alt="">
                                <p>Ottomans</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/10.png" alt="">
                                <p>Shelfs</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/11.png" alt="">
                                <p>Kid Furnitures</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 ">
                            <div class="ps-block--category">
                                <a href="shop-default.html"></a><img src="img/categories/furniture/12.png" alt="">
                                <p>Kitchen</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="ps-home-promotion-2">
            <div class="container">
                <a href="#"><img src="img/promotions/home-8/3.jpg" alt="padding-top: 10px; padding-bottom: 60px;"></a>
            </div>
        </div>
        <div class="ps-home-trending-products ps-section--furniture">
            <div class="container">
                <div class="ps-section__header">
                    <h3>Course By Branches</h3>
                </div>
                <div class="ps-section__content">
                    <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="4"
                        data-owl-duration="1000" data-owl-mousedrag="on">
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/12.jpg" alt=""></a>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/8.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/10.jpg" alt=""></a>
                        ...
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a href="product-default.html"><img src="img/products/furniture/9.jpg" alt=""></a>
                                <ul class="ps-product__actions">
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                ...
                <div class="ps-section__content">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-1.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-2.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-3.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-4.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-5.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-6.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-7.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--category-room">
                                <div class="ps-block__thumbnail">
                                    <a href="shop-default.html"><img src="img/categories/furniture/room-8.png" alt=""></a>
                                </div>
            ...
            <div class="container">
                ...
                <div class="ps-section__content">
                    <ul class="ps-image-list">
                        <li>
                            <a href="#"><img src="img/brand/2-1.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-2.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-3.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-4.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-5.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-6.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-7.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-8.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-9.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="img/brand/2-10.jpg" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
